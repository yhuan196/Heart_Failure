...
The Cox model results indicating creatinine as a significant predictor of survival are reasonable and supported by existing literature. *A study*(Zhang) published in Frontiers in Cardiovascular Medicine found that postoperative serum creatinine is a significant prognostic factor for cardiac surgery patients. The study showed that higher levels of postoperative serum creatinine were linked to increased hospital mortality and longer stays in the intensive care unit. Specifically, the study found that patients who did not survive had significantly higher postoperative serum creatinine levels, and there was a positive correlation between these levels and lengths of ICU stay. These findings highlight the importance of renal function, which is intricately linked with heart failure, as indicated by creatinine levels, in determining the survival outcomes for patients undergoing cardiac surgery.
