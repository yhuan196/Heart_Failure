...
The Gompertz model obtained from stepwise selection using AIC contains anaemia, sodium, bp, log(cre), ef_cat and age. 
...
For `anaemia`, for the variable "anaemia," comparing level 1 to the reference level 0, the coefficient of anaemia is 0.303, suggesting a 1.354 times higher hazard of the event in individuals with anaemia compared to those without. Although its p-value = 0.149 > 0.05, it was still considered small enough to be statistically significant.
...
# Plot ROC curves
plot(roc_50$FP, roc_50$TP, type = "l", col = "red", xlab = "1 - Specificity", ylab = "Sensitivity", main = "Figure 8.1: Time-Dependent ROC Curves for 50 and 250 Days")
