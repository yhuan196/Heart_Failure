...
where $O_{ij}$ is the observed number of events in group  j at time i, $E_{ij}$ is the expected number of events in group  $j$ at time  $i$,  $n_{ij}$ is the number of individuals at risk in group j at time $i$, $O_i$ is the total number of events at time $i$, and $n_i$ is the total number at risk at time $i$.
