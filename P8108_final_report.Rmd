...
results <- data.frame(
  ...
  Log.Rank = c(0.00254, 0.00141),
  Wilcoxon = c(0.00397, 0.00397)
)

results_table <- kable(results, align = "c") %>%
  kable_styling(latex_options = c("HOLD_position"), font_size = 8)

results_table
```

According to the above table, we find that both Log-Rank test and the Wilcoxon test gave us a p-value of 0.9. Thus, we fail to reject the null hypothesis and conclude that there is no significant difference in survival experience between males and females.
