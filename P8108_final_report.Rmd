...
```{r fig.align='center', fig.width=10, fig.cap="Figure 6.1: Schoenfeld Test For Log-transformed Creatinine"}
...
```{r fig.align='center', fig.width=10, fig.cap="Figure 6.2: Schoenfeld Test For Age"}
