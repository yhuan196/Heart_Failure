...
# Create table using kable
weibull_summary |> kable(booktabs = T, caption = "Table 5: Summary of Weibul PH Model Fitting", 
                         digits = 4) |>
  kable_styling(latex_options = c("HOLD_position"), font_size = 10) 
```
...
# Create table using kable
gompertz_summary %>% kable(booktabs = T, caption = "Table 6: Summary of Gompertz PH Model Fitting", 
                           digits = 4) |>
  kable_styling(latex_options = c("HOLD_position"), font_size = 10) 
