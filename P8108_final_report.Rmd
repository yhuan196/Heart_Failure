...
$V_{ij}$ represents the variance of the observed number of events in group $j$ at time $i$. The weight factor ensures that the survival differences at earlier time points carry more weight in the overall analysis. 
